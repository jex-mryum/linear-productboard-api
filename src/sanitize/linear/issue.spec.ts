...
describe(`issue sanitization`, () => {
  it(`\n\tGIVEN zod comment parsing \n\tWHEN valid remove issue data body received \n\tTHEN successful parsing`, () => {
    const parsed = parseIssueData(ActionType.Remove, {
  ...
  it(`\n\tGIVEN zod comment parsing \n\tWHEN valid update issue data body received \n\tTHEN successful parsing`, () => {
    const parsed = parseIssueData(ActionType.Update, {
      id: '8b0b1cdb-383a-4ed6-9f6c-5577657a253d',
      createdAt: '2022-03-16T23:25:39.330Z',
      updatedAt: '2022-03-16T23:40:31.518Z',
      number: 24,
  ...
  it(`\n\tGIVEN zod comment parsing \n\tWHEN partial valid issue data body received \n\tTHEN successful parsing`, () => {
    const parsed = parseIssueData(ActionType.Create, {
      id: '8b0b1cdb-383a-4ed6-9f6c-5577657a253d',
      createdAt: '2022-03-16T23:25:39.330Z',
      updatedAt: '2022-03-16T23:40:31.518Z',
      number: 24,
